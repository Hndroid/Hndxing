...
public final class PreferencesActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
    ...
    public void setKeyPlayBeepEnable(boolean beepEnable) {
        if (preferences != null) {
            CheckBoxPreference playBeep = (CheckBoxPreference) preferences.findPreference(KEY_PLAY_BEEP);
            playBeep.setChecked(beepEnable);
        }
    }

    public void setKeyVibrateEnable(boolean vibrateEnable) {
		if (preferences != null){
            CheckBoxPreference vibrate = (CheckBoxPreference) preferences.findPreference(KEY_VIBRATE);
            vibrate.setChecked(vibrateEnable);
        }
    }
